...
const config: Config = {
	title: "Waste Of Space Wiki (Rip arvid)",
	tagline:
		"If you cant find info on something in this wiki, make sure to ping hexcede in the WOS discord!",
	...
	themeConfig: {
		...
		themeConfig: {
			...
			announcementBar: {
				id: "find_outdated_info",
				content: "Report any undocumented and outdated info by opening an issue.",
